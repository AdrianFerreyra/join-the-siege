...
classifier = joblib.load(
    f"{settings.CLASSIFIER_SERVICE_DATA_VOLUME}/{settings.CLASSIFIER_SERVICE_MODEL_FILENAME}"
)
vectorizer = joblib.load(
    f"{settings.CLASSIFIER_SERVICE_DATA_VOLUME}/{settings.CLASSIFIER_SERVICE_VECTORIZER_FILENAME}"
)
